...
export class CostCentreComponent  implements OnInit {
  ...
  httpGet() {
    this.loading = true;
    const url = environment.api + "member/costCentre/";
  ...
  onUpdate() {
    this.loading = true;
    const url = environment.api + "member/costCentre/update";
  ...
  onDelete() {
    if (confirm("Delete this checklist?")) { 
      this.loading = true;
      const url = environment.api + "member/costCentre/delete";
      const body = this.items;
      this.http.post<any>(url, body, {
        headers: this.configService.headers(),
      }).subscribe(
  ...
  onSubmit() {
    this.loading = true;
    const url = environment.api + "member/costCentre/create";
    const body = {
      model: this.model,
    };
    this.http.post<any>(url, body, {
