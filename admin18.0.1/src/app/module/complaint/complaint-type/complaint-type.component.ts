...
export class ComplaintTypeComponent  implements OnInit {
  ...
  httpGet() {
    this.loading = true;
    const url = environment.api + "complaint/type/";
  ...
  onUpdate() {
    this.loading = true;
    const url = environment.api + "complaint/type/update";
  ...
  onDelete() {
    if (confirm("Delete this checklist?")) { 
      this.loading = true;
      const url = environment.api + "complaint/type/delete";
      const body = this.items;
      this.http.post<any>(url, body, {
        headers: this.configService.headers(),
      }).subscribe(
  ...
  onSubmit() {
    this.loading = true;
    const url = environment.api + "complaint/type/create";
    const body = {
      model: this.model,
    };
    this.http.post<any>(url, body, {
