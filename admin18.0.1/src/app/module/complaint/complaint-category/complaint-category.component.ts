...
export class ComplaintCategoryComponent  implements OnInit {
  ...
  httpGet() {
    this.loading = true;
    const url = environment.api + "complaint/category/";
  ...
  onUpdate() {
    this.loading = true;
    const url = environment.api + "complaint/category/update";
  ...
  onDelete() {
    if (confirm("Delete this checklist?")) { 
      this.loading = true;
      const url = environment.api + "complaint/category/delete";
      const body = this.items;
      this.http.post<any>(url, body, {
        headers: this.configService.headers(),
      }).subscribe(
  ...
  onSubmit() {
    this.loading = true;
    const url = environment.api + "complaint/category/create";
    const body = {
      model: this.model,
    };
    this.http.post<any>(url, body, {
