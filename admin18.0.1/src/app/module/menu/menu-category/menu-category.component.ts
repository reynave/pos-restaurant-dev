...
export class MenuCategoryComponent  implements OnInit {
  ...
  httpGet() {
    this.loading = true;
    const url = environment.api + "menu/category/";
  ...
  onUpdate() {
    this.loading = true;
    const url = environment.api + "menu/category/update";
  ...
  onDelete() {
    if (confirm("Delete this checklist?")) { 
      this.loading = true;
      const url = environment.api + "menu/category/delete";
      const body = this.items;
      this.http.post<any>(url, body, {
        headers: this.configService.headers(),
      }).subscribe(
  ...
  onSubmit() {
    this.loading = true;
    const url = environment.api + "menu/category/create";
    const body = {
      model: this.model,
    };
    this.http.post<any>(url, body, {
  ...
  open(content: any) {
   ...
   onDuplicate() {
    ...
    this.loading = true;
    const url = environment.api + 'menu/category/duplicate';
    const body = this.items;
