...
export class DiscGroupComponent implements OnInit {
  ...
  onUpdate() {
    this.loading = true;
    const url = environment.api + "discount/group/update";
  ...
  onDelete() {
    if (confirm("Delete this checklist?")) { 
      this.loading = true;
      const url = environment.api + "discount/group/delete";
      const body = this.items;
      this.http.post<any>(url, body, {
        headers: this.configService.headers(),
      }).subscribe(
  ...
  onSubmit() {
    this.loading = true;
    const url = environment.api + "discount/group/create";
    const body = {
      model: this.model,
    };
    this.http.post<any>(url, body, {
  ...
  onDuplicate() {
    ...
    this.loading = true;
    const url = environment.api + 'discount/group/duplicate';
    const body = this.items;
