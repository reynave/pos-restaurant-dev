...
@Component({
  selector: 'app-cashier-report-pos-desktop-printer-paper',
  standalone: true,
   imports: [NgbDatepickerModule, NgbAlertModule, FormsModule, CommonModule],
  templateUrl: './cashier-report-pos-desktop-printer-paper.component.html',
  styleUrl: './cashier-report-pos-desktop-printer-paper.component.css'
})
export class CashierReportPosDesktopPrinterPaperComponent implements OnInit {
  startDate: any = [];
  endDate: any = [];
